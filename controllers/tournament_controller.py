...
class TournamentController:
    ...
    def run_tournament(self, tournament_name, players, turn_number):
        ...
        while turn.current_turn < turn_number :
            ...
            self.p_in_t_view.display_players_in_tournament(score_sorter(Player().get_players_informations(turn.players)))

        #fin du tournoi afficher les joueurs et le vainqueur
        winners = self.get_winner(score_sorter(Player().get_players_informations(turn.players)))
